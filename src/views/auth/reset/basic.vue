            ...
            <b-card no-body class="mt-4">
              ...
              <b-card-body class="p-4">
                <div class="text-center mt-2">
                  ...
                  <lottie class="avatar-xl" colors="primary:#3cd188,secondary:#687cfe" :options="defaultOptions"
                ...
                <div class="p-2">
                  <form>
                    ...
                    <div class="text-center mt-4">
                      <b-button variant="secondary" class="w-100" type="submit">Send Reset Link</b-button>
                    </div>
                  </form>
                </div>
              </b-card-body>
