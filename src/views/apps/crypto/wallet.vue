          ...
          <b-card-header>
            <div class="d-flex align-items-center">
              ...
              <div class="toolbar d-flex align-items-start justify-content-center flex-wrap gap-2">
                <b-button type="button" variant="soft-success" size="sm" class="timeline-btn" id="one_month">
                  1M
                </b-button>
                <b-button type="button" variant="soft-success" size="sm" class="timeline-btn" id="six_months">
                  6M
                </b-button>
                <b-button type="button" variant="soft-success" size="sm" class="timeline-btn" id="one_year">
                  1Y
                </b-button>
                <b-button type="button" variant="soft-success" size="sm" class="timeline-btn active" id="all">
                  ALL
                </b-button>
              </div>
            </div>
                  ...
                  <tr v-for="(data, index) of resultQuery" :key="index">
                    ...
                    <td>
                      <div class="d-flex align-items-center fw-medium">
                        ...
                        <b-link href="javascript:void(0)" class="currency_name text-reset">{{
                            data.currency_name
                        }}</b-link>
                      </div>
                    </td>
