          ...
          <b-card-body>
            ...
            <div class="d-flex align-items-end justify-content-between mt-4">
              <div>
                ...
                <b-badge class="bg-secondary me-1">{{ item.badge }}</b-badge> <span class="text-muted">
                  {{ item.caption }}</span>
              </div>
        ...
        <b-card no-body id="invoiceList">
          ...
          <b-card-body>
            ...
            <b-modal v-model="invoiceListModal" id="deleteOrder" modal-class="flip" hide-footer
              ...
              <lottie class="avatar-xl" colors="primary:#687cfe,secondary:#f7666e" :options="defaultOptions1"
                :height="90" :width="90" />
