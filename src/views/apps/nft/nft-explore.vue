...
<template>
    <Layout>
                ...
                <b-card no-body>
                    <b-card-header class="border-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <b-link class="btn btn-primary" data-bs-toggle="collapse" href="#collapseExample"><i
        ...
        <div class="text-center mb-3">
            <b-button variant="link" class="text-secondary mt-2"><i class="mdi mdi-loading mdi-spin fs-20 align-middle me-2"></i> Load more </b-button>
        </div>
    </Layout>
</template>