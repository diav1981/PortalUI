                    ...
                    <b-col lg="4">
                        <div class="sticky-side-div">
                            ...
                            <div class="hstack gap-2">
                                <b-button variant="primary" class="w-100">Place Bid</b-button>
                            </div>
                        </div>
                    </b-col>
                    <b-col lg="8">
                        <div>
                            ...
                            <b-badge variant="soft-secondary" class="badge-soft-secondary mb-3 fs-12"><i class="ri-eye-line me-1 align-bottom"></i>
