                    ...
                    <b-col lg="4" md="6">
                        <b-card no-body>
                            <b-card-body>
                                ...
                                <h5 class="mb-0 fs-16">
                                    <b-link href="#!" class="text-reset">Crypto Card <b-badge variant="soft-success" class="badge-soft-success">743</b-badge>
                                    </b-link>
                                </h5>
                            </b-card-body>
                        </b-card>
                        ...
                        <b-card no-body>
                            <b-card-body>
                                ...
                                <b-link href="#!" class="float-end"> View All <i
                                        class="ri-arrow-right-line align-bottom"></i></b-link>
                                <h5 class="mb-0 fs-16">
                                    <b-link href="#!" class="text-reset">Artwork <b-badge variant="soft-success" class="badge-soft-success">206</b-badge></b-link>
                                </h5>
                            </b-card-body>
                        </b-card>
                    </b-col>
                        ...
                        <b-card no-body>
                            <b-card-body>
                                ...
                                <b-link href="#!" class="float-end"> View All <i
                                        class="ri-arrow-right-line align-bottom"></i></b-link>
                                <h5 class="mb-0 fs-16">
                                    <b-link href="#!" class="text-reset">Music <b-badge variant="soft-success" class="badge-soft-success">679</b-badge></b-link>
                                </h5>
                            </b-card-body>
                        </b-card>
                    </b-col>
            ...
            <b-col lg="12">
                <div class="d-lg-flex align-items-center mb-4">
                    ...
                    <div class="flex-shrink-0 mt-4 mt-lg-0">
                        <b-link href="/apps/nft-explore" class="btn btn-soft-secondary">View All <i
                                class="ri-arrow-right-line align-bottom"></i></b-link>
                    </div>
                </div>
            </b-col>
                ...
                <b-card no-body class="explore-box">
                    <b-card-body>
                        ...
                        <div class="mt-3">
                            ...
                            <h6 class="fs-16 mb-0">
                                <b-link href="/apps/nft-item-detail" class="text-reset">Patterns arts & culture</b-link>
                            </h6>
                        </div>
                    </b-card-body>
                </b-card>
                ...
                <b-card no-body class="explore-box">
                    <b-card-body>
                        ...
                        <div class="mt-3">
                            ...
                            <h6 class="fs-16 mb-0">
                                <b-link href="/apps/nft-item-detail" class="text-reset">Evolved Reality</b-link>
                            </h6>
                        </div>
                    </b-card-body>
                </b-card>
                ...
                <b-card no-body class="explore-box">
                    <b-card-body>
                        ...
                        <div class="mt-3">
                            ...
                            <h6 class="fs-16 mb-0">
                                <b-link href="/apps/nft-item-detail" class="text-reset">Long-tailed macaque</b-link>
                            </h6>
                        </div>
                    </b-card-body>
                </b-card>
                ...
                <b-card no-body class="explore-box">
                    <b-card-body>
                        ...
                        <div class="mt-3">
                            ...
                            <h6 class="fs-16 mb-0">
                                <b-link href="/apps/nft-item-detail" class="text-reset">Robotic Body Art</b-link>
                            </h6>
                        </div>
                    </b-card-body>
                </b-card>
                ...
                <b-card no-body class="explore-box">
                    <b-card-body>
                        ...
                        <div class="mt-3">
                            ...
                            <h6 class="fs-16 mb-0">
                                <b-link href="/apps/nft-item-detail" class="text-reset">Creative filtered portrait</b-link>
                            </h6>
                        </div>
                    </b-card-body>
                </b-card>
        ...
        <b-row>
            <b-col lg="12">
                <div class="d-lg-flex align-items-center mb-4">
                    ...
                    <div class="flex-shrink-0 mt-4 mt-lg-0">
                        <b-link href="/apps/nft-creators" class="btn btn-soft-secondary">View All <i
                                class="ri-arrow-right-line align-bottom"></i></b-link>
                    </div>
                </div>
            </b-col>
            ...
            <b-col>
                <b-card no-body class="explore-box card-animate">
                    ...
                    <div class="explore-place-bid-img">
                        ...
                        <div class="bg-overlay"></div>
                        <div class="place-bid-btn">
                            <b-link href="#!" class="btn btn-secondary"><i class="ri-auction-fill align-bottom me-1"></i>
                                Place
                                Bid</b-link>
                        </div>
                    </div>
                    <b-card-body>
                        <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                            23.63k </p>
                        <h5 class="mb-1 fs-16">
                            <b-link href="/apps/nft-item-detail" class="text-reset">The Chirstoper</b-link>
                        </h5>
            ...
            <b-col>
                <b-card no-body class="explore-box card-animate">
                    ...
                    <b-card-body>
                        ...
                        <h5 class="mb-1 fs-16">
                            <b-link href="/apps/nft-item-detail" class="text-reset">Trendy fashion portraits</b-link>
                        </h5>
                ...
                <b-card no-body class="explore-box card-animate">
                    ...
                    <b-card-body>
                        <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                            34.12k </p>
                        <h5 class="mb-1 fs-16">
                            <b-link href="/apps/nft-item-detail" class="text-reset">Smillevers Crypto</b-link>
                        </h5>
                ...
                <b-card no-body class="explore-box card-animate">
                    ...
                    <b-card-body>
                        <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                            14.85k </p>
                        <h5 class="mb-1 fs-16">
                            <b-link href="/apps/nft-item-detail" class="text-reset">Abstract face painting</b-link>
                        </h5>
            ...
            <b-col>
                <b-card no-body>
                    ...
                    <b-card-body class="text-center">
                        ...
                        <h5 class="fs-16 mt-3 mb-1">
                            <b-link href="#!" class="text-reset">Tonya Noble</b-link>
                        </h5>
                ...
                <b-card no-body>
                    ...
                    <b-card-body class="text-center">
                        <img src="@/assets/images/nft/img-04.jpg" alt=""
                            class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
                        <h5 class="fs-16 mt-3 mb-1">
                            <b-link href="#!" class="text-reset">Kevin Dawson</b-link>
                        </h5>
                ...
                <b-card no-body>
                    ...
                    <b-card-body class="text-center">
                        <img src="@/assets/images/nft/img-06.jpg" alt=""
                            class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
                        <h5 class="fs-16 mt-3 mb-1">
                            <b-link href="#!" class="text-reset">Herbert Stokes</b-link>
                        </h5>
                ...
                <b-card no-body>
                    ...
                    <b-card-body class="text-center">
                        <img src="https://img.themesbrand.com/velzon/images/img-2.gif" alt=""
                            class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
                        <h5 class="fs-16 mt-3 mb-1">
                            <b-link href="#!" class="text-reset">Thomas Taylor</b-link>
                        </h5>
                ...
                <b-card no-body>
                    ...
                    <b-card-body class="text-center">
                        <img src="https://img.themesbrand.com/velzon/images/img-1.gif" alt=""
                            class="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover">
                        <h5 class="fs-16 mt-3 mb-1">
                            <b-link href="#!" class="text-reset">James Price</b-link>
                        </h5>
