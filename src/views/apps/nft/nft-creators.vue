...
<template>
    <Layout>
        ...
        <b-row class="g-4 mb-3">
            <b-col sm>
                <div>
                    <b-link href="/apps/projects-create" class="btn btn-secondary"><i
                ...
                <b-card no-body>
                    ...
                    <b-card-body class="text-center">
                        ...
                        <p class="text-muted">You can make an NFT of a digital painting, a text, a piece of music, a
                            video.</p>
                        <b-button variant="soft-primary" class="w-100">Unfollow</b-button>
                    </b-card-body>
                </b-card>
            </b-col>
            <b-col>
                <b-card no-body>
                    ...
                    <b-card-body class="text-center">
                        ...
                        <p class="text-muted">You can make an NFT of a digital painting, a text, a piece of music, a
                            video.</p>
                        <b-button variant="primary" class="w-100">Follow</b-button>
                    </b-card-body>
                </b-card>
            </b-col>
            <b-col>
