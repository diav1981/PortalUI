            ...
            <b-col xl="3" md="4" sm="6">
                <b-card no-body>
                    <b-card-body>
                        ...
                        <h5 class="mb-0 fs-16">
                            <b-link href="#!" class="text-reset">Crypto Card <b-badge variant="soft-success" class="badge-soft-success">743</b-badge></b-link>
                        </h5>
                    </b-card-body>
                </b-card>
            </b-col>
            ...
            <b-col xl="3" md="4" sm="6">
                <b-card no-body>
                    <b-card-body>
                        ...
                        <h5 class="mb-0 fs-16">
                            <b-link href="#!" class="text-reset">Games <b-badge variant="soft-success" class="badge-soft-success">341</b-badge></b-link>
                        </h5>
                    </b-card-body>
                </b-card>
            </b-col>
            <b-col xl="3" md="4" sm="6">
                <b-card no-body>
                    <b-card-body>
                        ...
                        <h5 class="mb-0 fs-16">
                            <b-link href="#!" class="text-reset">Photography <b-badge variant="soft-success" class="badge-soft-success">1452</b-badge></b-link>
                        </h5>
                    </b-card-body>
                </b-card>
            </b-col>
            <b-col xl="3" md="4" sm="6">
                <b-card no-body>
                    <b-card-body>
                        ...
                        <h5 class="mb-0 fs-16">
                            <b-link href="#!" class="text-reset">3d Style <b-badge variant="soft-success" class="badge-soft-success">4781</b-badge></b-link>
                        </h5>
                    </b-card-body>
                </b-card>
            </b-col>
            <b-col xl="3" md="4" sm="6">
                <b-card no-body>
                    <b-card-body>
                        ...
                        <h5 class="mb-0 fs-16">
                            <b-link href="#!" class="text-reset">Collectibles <b-badge variant="soft-success" class="badge-soft-success">3468</b-badge></b-link>
                        </h5>
                    </b-card-body>
                </b-card>
            </b-col>
            <b-col xl="3" md="4" sm="6">
                <b-card no-body>
                    <b-card-body>
                        ...
                        <h5 class="mb-0 fs-16">
                            <b-link href="#!" class="text-reset">Videos <b-badge variant="soft-success" class="badge-soft-success">1674</b-badge></b-link>
                        </h5>
                    </b-card-body>
                </b-card>
            </b-col>
