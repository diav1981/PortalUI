  ...
  <Layout>
            ...
            <b-row class="justify-content-between gy-3">
              ...
              <b-col lg="auto">
                <div class="d-md-flex text-nowrap gap-2">
                  <b-button variant="primary" class="add-btn"><i class="ri-add-fill me-1 align-bottom"></i> Add Categories</b-button>
                  <b-button variant="secondary" ><i class="ri-filter-2-line me-1 align-bottom"></i> Filters</b-button>
    ...
    <b-row class="row-cols-xxl-5 row-cols-lg-3 row-cols-md-2 row-cols-1">
      <b-col>
        <b-card no-body>
          <b-card-body class="text-center py-4">
            <lottie class="avatar-xl icon-primary" colors="primary:#687cfe" :options="defaultOptions" :height="50" :width="50" />
      ...
      <b-col>
        <b-card no-body>
          <b-card-body class="text-center py-4">
            <lottie class="avatar-xl icon-primary" colors="primary:#687cfe" :options="defaultOptions1" trigger="hover" :height="50"
              :width="50" />
            <b-link href="#!" class="stretched-link">
      ...
      <b-col>
        <b-card no-body>
          <b-card-body class="text-center py-4">
            <lottie class="avatar-xl icon-primary" colors="primary:#687cfe" :options="defaultOptions2" trigger="hover" :height="50"
              :width="50" />
            <b-link href="#!" class="stretched-link">
      ...
      <b-col>
        <b-card no-body>
          <b-card-body class="text-center py-4">
            <lottie class="avatar-xl icon-primary" colors="primary:#687cfe" :options="defaultOptions3" trigger="hover" :height="50"
              :width="50" />
            <b-link href="#!" class="stretched-link">
      ...
      <b-col>
        <b-card no-body>
          <b-card-body class="text-center py-4">
            <lottie class="avatar-xl icon-primary" colors="primary:#687cfe" :options="defaultOptions4" trigger="hover" :height="50"
              :width="50" />
            <b-link href="#!" class="stretched-link">
      ...
      <b-col>
        <b-card no-body>
          <b-card-body class="text-center py-4">
            <lottie class="avatar-xl icon-primary" colors="primary:#687cfe" :options="defaultOptions5" trigger="hover" :height="50"
              :width="50" />
            <b-link href="#!" class="stretched-link">
      ...
      <b-col>
        <b-card no-body>
          <b-card-body class="text-center py-4">
            <lottie class="avatar-xl icon-primary" colors="primary:#687cfe" :options="defaultOptions6" :trigger="hover" :height="50"
              :width="50" />
            <b-link href="#!" class="stretched-link">
      ...
      <b-col>
        <b-card no-body>
          <b-card-body class="text-center py-4">
            <lottie class="avatar-xl icon-primary" colors="primary:#687cfe" :options="defaultOptions7" trigger="hover" :height="50"
              :width="50" />
            <b-link href="#!" class="stretched-link">
      ...
      <b-col>
        <b-card no-body>
          <b-card-body class="text-center py-4">
            <lottie class="avatar-xl icon-primary" colors="primary:#687cfe" :options="defaultOptions8" trigger="hover" :height="50"
              :width="50" />
            <b-link href="#!" class="stretched-link">
      ...
      <b-col>
        <b-card no-body>
          <b-card-body class="text-center py-4">
            <lottie class="avatar-xl icon-primary" colors="primary:#687cfe" :options="defaultOptions9" trigger="hover" :height="50"
              :width="50" />
            <b-link href="#!" class="stretched-link">
      ...
      <b-col>
        <b-card no-body>
          <b-card-body class="text-center py-4">
            <lottie class="avatar-xl icon-primary" colors="primary:#687cfe" :options="defaultOptions10" trigger="hover" :height="50"
              :width="50" />
            <b-link href="#!" class="stretched-link">
      ...
      <b-col>
        <b-card no-body>
          <b-card-body class="text-center py-4">
            <lottie class="avatar-xl icon-primary" colors="primary:#687cfe" :options="defaultOptions11" trigger="hover" :height="50"
              :width="50" />
            <b-link href="#!" class="stretched-link">
      ...
      <b-col>
        <b-card no-body>
          <b-card-body class="text-center py-4">
            <lottie class="avatar-xl icon-primary" colors="primary:#687cfe" :options="defaultOptions12" trigger="hover" :height="50"
              :width="50" />
            <b-link href="#!" class="stretched-link">
      ...
      <b-col>
        <b-card no-body>
          <b-card-body class="text-center py-4">
            <lottie class="avatar-xl icon-primary" colors="primary:#687cfe" :options="defaultOptions13" trigger="hover" :height="50"
              :width="50" />
            <b-link href="#!" class="stretched-link">
      ...
      <b-col>
        <b-card no-body>
          <b-card-body class="text-center py-4">
            <lottie class="avatar-xl icon-primary" colors="primary:#687cfe" :options="defaultOptions14" trigger="hover" :height="50"
              :width="50" />
            <b-link href="#!" class="stretched-link">
