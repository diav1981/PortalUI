...
<template>
            ...
            <div class="d-md-flex align-items-center">
              ...
              <div class="flex-shrink-0">
                <div class="d-flex gap-1 flex-wrap">
                  <b-button type="button" class="add-btn" variant="primary" id="create-btn"
                    @click="(e) => handleApplicationdetails(e)"><i class="ri-add-line align-bottom me-1"></i>
                    Create
                    Application</b-button>
                  <b-button type="button" variant="secondary"><i class="ri-file-download-line align-bottom me-1"></i>Import
                  </b-button>
  ...
  { value: 'Part Time', label: 'Part Time' },
                ...
                <b-col xxl="1" sm="4">
                  <div>
                    <b-button type="button" variant="success" @click="SearchData" class="w-100"> <i
