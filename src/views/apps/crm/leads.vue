            ...
            <b-row class="g-4 align-items-center">
              ...
              <b-col sm="auto" class="ms-auto">
                <div class="hstack gap-2">
                  ...
                  <b-button type="button" variant="primary" data-bs-toggle="offcanvas" href="#offcanvasExample">
      ...
      <b-form action="" id="addform" class="tablelist-form" autocomplete="off">
        ...
        <div class="modal-footer v-modal-footer mt-3">
          <div class="hstack gap-2 justify-content-end">
            ...
            <b-button type="submit" variant="primary" id="add-btn" @click="addorder">Add leads</b-button>
            <b-button type="button" variant="primary" id="edit-btn" @click="updateorder">Update</b-button>
          </div>
        </div>
      </b-form>
    </b-modal>
