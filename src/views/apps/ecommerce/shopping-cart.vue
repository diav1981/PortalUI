  ...
  <Layout>
        ...
        <div class="sticky-side-div">
          ...
          <b-alert variant="danger" class="border-dashed" role="alert" show>
            <div class="d-flex align-items-center">
              <lottie colors="primary:#121331,secondary:#f7666e" :options="defaultOptions" :height="80" :width="80"
                style="margin:0px;" />
              <div class="ms-2">
    ...
    <b-modal v-model="removeItemModal" id="removeItemModal" modal-class="zoomIn" hide-footer title="Update Customer"
      ...
      <div class="mt-2 text-center">
        <lottie colors="primary:#121331,secondary:#f7666e" :options="defaultOptions" :height="100" :width="100" />
