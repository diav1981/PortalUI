              ...
              <div class="tab-content">
                <div class="tab-pane fade show active" id="pills-bill-info" role="tabpanel"
                  ...
                  <div>
                    ...
                    <div class="d-flex align-items-start gap-3 mt-3">
                      <b-button variant="secondary" type="button" class="btn-label right ms-auto nexttab"
                ...
                <div class="tab-pane fade" id="pills-bill-address" role="tabpanel"
                  ...
                  <div class="mt-4">
                    <div class="d-flex align-items-center mb-2">
                      ...
                      <div class="flex-shrink-0">
                        <b-button type="button" variant="info" size="sm" class="mb-3">
                          Add Address
                        </b-button>
                      </div>
                    </div>
                  ...
                  <div class="d-flex align-items-start gap-3 mt-4">
                    ...
                    <b-button type="button" variant="secondary" class="btn-label right ms-auto nexttab"
                ...
                <div class="tab-pane fade" id="pills-finish" role="tabpanel" aria-labelledby="pills-finish-tab">
                  <div class="text-center py-5">
                    <div class="mb-4">
                      <lottie colors="primary:#3cd188,secondary:#687cfe" :options="defaultOptions" :height="120"
                        :width="120" />
                    </div>
