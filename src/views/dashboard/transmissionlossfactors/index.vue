            ...
            <b-card no-body>
              <b-card-body class="p-0">
                ...
                <ul class="nav nav-pills nav-custom nav-custom-light mb-3" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" href="#nav-light-home" target="_self" data-bs-toggle="tab" role="tab"> Offtaking </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#nav-light-profile" target="_self" data-bs-toggle="tab" role="tab"> Delivering </a>
                  </li>
                </ul>
