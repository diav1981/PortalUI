        ...
        <nav class="navbar navbar-expand-lg navbar-landing fixed-top job-navbar" id="navbar">
            <b-container fluid class="custom-container">
                ...
                <b-collapse class="navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="">
                        <b-link href="/auth/signin-basic" class="btn btn-soft-secondary"><i
        ...
        <section class="py-5 bg-primary position-relative">
            ...
            <b-container>
                <b-row class="align-items-center gy-4">
                    ...
                    <b-col sm="auto">
                        <div>
                            <b-link href="#!" class="btn bg-gradient btn-secondary">Create Free Account</b-link>
                        </div>
                    </b-col>
                    ...
                    <b-col lg="4" md="6">
                        <b-card no-body>
                            ...
                            <b-card-body>
                                ...
                                <div>
                                    <b-link href="#!" class="link-secondary">Learn More <i
                                            class="ri-arrow-right-line align-bottom ms-1"></i></b-link>
                                </div>
                            </b-card-body>
                        </b-card>
        ...
        <section class="py-5 bg-primary position-relative">
            ...
            <b-container>
                <b-row class="align-items-center gy-4">
                    ...
                    <b-col sm="auto">
                        <b-button type="button" variant="secondary">Subscribe Now <i
