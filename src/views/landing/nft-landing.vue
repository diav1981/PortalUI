                    ...
                    <b-col lg="4">
                        <b-card no-body class="text-center border shadow-none">
                            <b-card-body class="py-5 px-4">
                                ...
                                <b-link href="#!" class="btn btn-soft-primary">Connect Wallet</b-link>
                            </b-card-body>
                        </b-card>
                    </b-col>
                    <b-col lg="4">
                        <b-card no-body class="text-center border shadow-none">
                            <b-card-body class="py-5 px-4">
                                ...
                                <b-link href="#!" class="btn btn-primary">Change Wallet</b-link>
                            </b-card-body>
                        </b-card>
                    </b-col>
                        ...
                        <div class="b-card no-body shadow-none">
                            <b-card-body>
                                ...
                                <p class="text-muted">You have to choose whether to use a hot wallet a cold
                                    wallet.</p>
                                <b-link href="#!" class="link-secondary">Read More <i
        ...
        <section class="py-5 bg-primary position-relative">
            ...
            <b-container>
                <b-row class="align-items-center gy-4">
                    ...
                    <b-col sm="auto">
                        <div>
                            <router-link to="/apps/nft-create" class="btn bg-gradient btn-success">Create NFT
                            </router-link>
