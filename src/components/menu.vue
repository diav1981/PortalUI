                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarForms">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <router-link to="/form/editors" class="nav-link" data-key="t-editors">
                                    {{ $t("t-editors") }}
                                </router-link>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarTables">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <router-link to="/tables/gridjs" class="nav-link" data-key="t-grid-js">
                                    {{ $t("t-grid-js") }}
                                </router-link>
                            </li>
                        </ul>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarCharts">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <router-link to="/charts/echart" class="nav-link" data-key="t-echarts">
                                    {{ $t("t-echarts") }}
                                </router-link>
                            </li>
                        </ul>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarIcons">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <router-link to="/icons/feather" class="nav-link" data-key="t-feather">
                                    {{ $t("t-feather") }}
                                </router-link>
                            </li>
                        </ul>
            ...
            <ul class="navbar-nav h-100" id="navbar-nav">
                ...
                <li class="nav-item">
                    <b-link class="nav-link menu-link" href="#sidebarDashboards" data-bs-toggle="collapse" role="button"
                            aria-expanded="false" aria-controls="sidebarDashboards">
                        <i class="ri-dashboard-2-line"></i>
                        <span data-key="t-industry-flows"> {{ $t("t-industry-flows") }}</span>
                    </b-link>
                    <div class="collapse menu-dropdown" id="sidebarDashboards">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <router-link to="/dashboard/llf" class="nav-link custom-abc" data-key="t-line-loss-factors">
                                    {{ $t("t-line-loss-factors") }}
                                </router-link>
                            </li>
                            <li class="nav-item">
                                <router-link to="/dashboard/meteredconsumption" class="nav-link" data-key="t-metered-consumption">
                                    {{ $t("t-metered-consumption") }}
                                </router-link>
                            </li>
                            <li class="nav-item">
                                <router-link to="/dashboard/tlf" class="nav-link" data-key="t-transmission-loss-factors">
                                    {{ $t("t-transmission-loss-factors") }}
                                </router-link>
                            </li>
                            <li class="nav-item">
                                <router-link to="/dashboard/billableconsumption" class="nav-link" data-key="t-billable-consumption">
                                    {{ $t("t-billable-consumption") }}
                                </router-link>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarApps">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <router-link to="/dashboard/duos" class="nav-link" data-key="t-duos">
                                    {{ $t("t-duos") }}
                                </router-link>
                            </li>
                        </ul>
                ...
                <li class="nav-item">
                    <b-link class="nav-link menu-link" href="#industryPricing" data-bs-toggle="collapse" role="button"
                            aria-expanded="false" aria-controls="industryPricing">
                        <i class="ri-account-circle-line"></i>
                        <span data-key="t-industry-pricing"> {{ $t("t-industry-pricing") }}</span>
                    </b-link>
                    <div class="collapse menu-dropdown" id="industryPricing">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <b-link href="#industrypricingauto" class="nav-link" data-bs-toggle="collapse" role="button"
                                        aria-expanded="false" aria-controls="industrypricingauto" data-key="t-industry-pricing-auto">
                                    {{ $t("t-industry-pricing-auto") }}
                                </b-link>
                            ...
                            <li class="nav-item">
                                <b-link href="#industrypricingmanual" class="nav-link" data-bs-toggle="collapse" role="button"
                                        aria-expanded="false" aria-controls="industrypricingmanual" data-key="t-industry-pricing-manual">
                                    {{ $t("t-industry-pricing-manual") }}
                                </b-link>
                                <div class="collapse menu-dropdown" id="industrypricingmanual">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <router-link to="/auth/signup-cover" class="nav-link" data-key="t-industry-pricing-manual-duos">
                                                {{ $t("t-industry-pricing-manual-duos") }}
                                            </router-link>
                                        </li>
                                        <li class="nav-item">
                ...
                <li class="nav-item">
                    <b-link class="nav-link menu-link" href="#governmentlevies" data-bs-toggle="collapse" role="button"
                            aria-expanded="false" aria-controls="governmentlevies">
                        <i class="ri-pages-line"></i>
                    ...
                    <div class="collapse menu-dropdown" id="governmentlevies">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <router-link to="/pages/starter" class="nav-link" data-key="t-governmentlevies-vat">
                                    {{ $t("t-governmentlevies-vat") }}
                                </router-link>
                            </li>
                        </ul>
                    </div>
